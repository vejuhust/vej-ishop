...
#define MODEL       "model/add_done"        /*网页模板文件地址*/
#define PAGE        "baby/add_done.htm"     /*生成的网页的地址*/
...
struct web_t    web;                        /*Shop链节点*/
struct shop_t   shop;                       /*Order链节点*/
...
void generate_add_done(void) {
    ...
    *mark2 = '\0';
    ...
    /*在标记二处填入信息*/
    strcat(new, "../cgi-bin/make_add_shop");
    mark2 += strlen(m2);
    strcat(new, mark2);
...
int main(int argc, char** argv) {
    ...
    transfer_input(tmpstr, len, 'B', &shop);
