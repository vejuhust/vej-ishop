...
#define MODEL       "model/handle_order"            /*网页模板文件地址*/
#define PAGE        "baby/handle_order.htm"         /*生成的网页的地址*/
...
struct order_t  order   [ORDER_MAX];                /*Order链全部节点*/
